...
\author[1,2,3]{Carlos Lezama}
\author[1,2,3]{Marco Medina}
\author[1,2,3]{Emiliano Ramírez}
\author[1,2,3]{Santiago Villarreal}

  \affil[1]{Instituto Tecnológico Autónomo de México}
...
\equalauthors{\textsuperscript{2} Todos los autores contribuyeron a este
trabajo por igual.}

\correspondingauthor{\textsuperscript{3} Trabajo presentado para el
