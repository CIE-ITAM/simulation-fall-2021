...
```{r dist_pareto, fig.height = 4, fig.fullweight = TRUE, echo = FALSE}
...
```{r bancarrota, fig.height=3, echo = FALSE}
# Creamos la semilla para la simulación
set.seed(2419231)
...
```{r expected_activos, fig.height=3, echo=FALSE}
# Creamos la semilla para la simulación
set.seed(945821)
...
```{r activos_ganancias, include = FALSE}
...
```{r simul_ganancias, include = FALSE}
# Creamos la semilla para la simulación
set.seed(4296531)
...
```{r graphs_ganancia_1, fig.height = 2.3, echo = FALSE}
...
```{r graphs_ganancia_2, fig.height = 2.3, echo = FALSE}
...
```{r graphs_ganancia_3, fig.height = 2.3, echo = FALSE}
# Graficamos los activos esperados
...
Como podemos observar en la gráficas, se mantiene que la probabilidad de bancarrota crece rápidamente para $p = 0.2$, mientras que es cero para $p = 0.1$ y $p = 0.01$ y ligeramente positiva para $p = 0.15$. Asimismo, en los activos esperados, podemos ver que hay una clara tendencia decreciente para los activos cuando $p = 0.2$, mientras que las demás no siguen una tendencia fija. Si añadieramos más puntos (periodos), las líneas que veríamos para $p = 0.1 y 0.01$ serían ruido alrededor de un cierto nivel $\bar{M}$. Por último, para las ganancias esperadas, es claro que la tendencia de las ganancias es mayor conforme la probabilidad de reclamo es menor.
...
```{r rcauchy_simul, fig.height=3.5, fig.fullweight = TRUE, echo=FALSE}
# Creamos la semilla para la simulación
set.seed(332442)
...
```{r rgumbel_simul, fig.height=3.5, fig.fullweight = TRUE, echo=FALSE}
# Creamos la semilla para la simulación
set.seed(346342)
...
```{r rlogistic_simul, fig.height=3.5, fig.fullweight = TRUE, echo=FALSE}
# Creamos la semilla para la simulación
set.seed(2353462)
...
```{r rpareto_simul, fig.height=3.5, fig.fullweight = TRUE, echo=FALSE}
# Creamos la semilla para la simulación
set.seed(942062)
