...
5. Probar que la parte fraccionaria de la suma de uniforemes $[0,1]$ $U_1 + \cdots + U_k$ es también uniforme en el intervalo [0,1]. (\textit{hint:} usar inducción matemática)
...
\[f_{\{U_1 + U_2\}}(u) = K_Z(z) = \int_{\mathcal{R}}K(z,w)dw= \begin{cases*} 
...
cuadradoMedio <- function(semilla){
  ...
  if (nchar(semilla)%%2==0) { #si semilla tiene #car par
